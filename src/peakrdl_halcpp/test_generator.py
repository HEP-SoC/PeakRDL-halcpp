...
class TestGenerator:
    ...
    def export(self, node: AddrmapNode, outdir: str) -> None:
        ...
        for addrmap in listener.addrmaps:
            ...
            out_file = os.path.join(outdir, f"test_{addrmap.get_path('_')}.cpp")
        ...
        cmake_out_file = os.path.join(outdir, "CMakeLists.txt")
    ...
    def process_template(
        ...
        env.filters.update({"zip": zip, "resolve_path_array_refs": resolve_path_array_refs})
