...
string(APPEND CMAKE_C_FLAGS " -march=rv32imc")
# int and pointers are 32bit, long 64bit, char 8bit, short 16bit
string(APPEND CMAKE_C_FLAGS " -mabi=ilp32")

string(APPEND CMAKE_ASM_FLAGS " -mabi=ilp32")
string(APPEND CMAKE_ASM_FLAGS " -march=rv32imc")
...
string(APPEND CMAKE_C_FLAGS " -ffreestanding -nostdlib")
...
string(APPEND CMAKE_EXE_LINKER_FLAGS " -ffreestanding -nostdlib")
